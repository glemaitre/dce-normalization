...
\begin{figure*}
  \centering
  \hspace*{\fill}
  \subfloat[Quantiative model without normalization.]{\label{fig:rfpharmaunorm}\includegraphics[width=.32\textwidth]{03_experiments/figures/unormalized/unormalized_methods_0.pdf}} \hfill
  \subfloat[Quantitative model With normalization.]{\label{fig:rfpharmanorm}\includegraphics[width=.32\textwidth]{03_experiments/figures/normalized/normalized_methods_0.pdf}}
  %\hspace*{\fill}
  %\hspace*{\fill}
  \hfill
  \subfloat[Entire enhanced \acs*{dce} signal classification.]{\label{fig:rfnormdcesignal}\includegraphics[width=.32\textwidth]{03_experiments/figures/full_signal_0.pdf}}
  \hspace*{\fill}
