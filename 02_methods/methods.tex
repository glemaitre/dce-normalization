...
\begin{figure*}
  \centering
  \hspace*{\fill}
  \subfigure[]{\label{subfig:pathist}\includegraphics[width=.35\textwidth]{02_methods/figures/IMG_20160824_122328.jpg}} \hfill
  \subfigure[]{\label{subfig:heatmaprep}\includegraphics[width=.5\textwidth]{02_methods/figures/pat2.pdf}}
  \hspace*{\fill}
  \\
  \hspace*{\fill}
  \subfigure{\includegraphics[width=.2\textwidth]{02_methods/figures/pat1.pdf}} \hfill
  \subfigure[]{\label{subfig:pat2}\includegraphics[width=.2\textwidth]{02_methods/figures/pat2.pdf}} \hfill
  \subfigure{\includegraphics[width=.2\textwidth]{02_methods/figures/pat2.pdf}}
  \hspace*{\fill}
  \caption{Illustration of the variations of the intensity \acs*{pdf} over time of two patients in a \ac{dce}-\ac{mri}.}
  \label{fig:heatmap}
\end{figure*}

In \ac{dce}-\ac{mri}, the intensity \ac{pdf} does not follow a unique type of distribution such as Rician or Gaussian distribution, as shown in Fig.\,\ref{subfig:pathist}.
Indeed, the inter-patient variations are more complex due to the temporal acquisition.
A better representation to observed these variations is to represent the intensity \ac{pdf} of the \ac{dce}-\ac{mri} data over time (see Fig.\,\ref{subfig:pathist}) using a heatmap representation as shown in Fig.\,\ref{subfig:heatmaprep}.
