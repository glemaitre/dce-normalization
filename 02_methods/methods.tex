...
\begin{figure*}
  \centering
  \hspace*{\fill}
  \subfloat[]{\label{subfig:pathhist}\includegraphics[width=1\textwidth]{02_methods/figures/heatmaprep.pdf}} \hfill
  \hspace*{\fill}
  \\
  \hspace*{\fill}
  \subfloat[$I_0$: 117; $t_0$: 6\textsuperscript{th} serie; wider st. dev.]{\label{subfig:pat1}\includegraphics[width=.49\textwidth]{02_methods/figures/pat1_annotated.pdf}} \hfill
  \subfloat[$I_0$: 103; $t_0$: 4\textsuperscript{th} serie; narrower std. dev.]{\label{subfig:pat2}\includegraphics[width=.49\textwidth]{02_methods/figures/pat2_annotated.pdf}} \hfill
  \hspace*{\fill}
  \caption{\protect\subref{subfig:pathhist} Illustration of the heatmap
    ...
    \protect\subref{subfig:pat1}-\protect\subref{subfig:pat2} Heatmap of 2 patients
...
\begin{figure*}
  \centering
  \hspace*{\fill}
  \subfloat[\acs*{rmse} computed for each patient of our dataset.]{\label{fig:rmse}\includegraphics[width=.44\textwidth]{02_methods/figures/rmse.pdf}} \hfill
  \subfloat[\acs*{rmse} after alignment using the curve parametric model.]{\label{fig:rmseal}\includegraphics[width=.49\textwidth]{02_methods/figures/rmse_aligned.pdf}}
  \hspace*{\fill}
...
\begin{figure*}
  \centering
  \hspace*{\fill}
  \subfloat[Original image.]{\label{fig:org}\includegraphics[width=.3\textwidth]{02_methods/figures/original.pdf}} \hfill
  \subfloat[Candidates region after clustering.]{\label{fig:cand}\includegraphics[width=.3\textwidth]{02_methods/figures/candidate.pdf}} \hfill
  \subfloat[Regions selected after applying the different criteria.]{\label{fig:final}\includegraphics[width=.3\textwidth]{02_methods/figures/aif.pdf}}
  \hspace*{\fill}
