...
\begin{figure*}
  ...
  \subfigure[]{\label{subfig:pat2}\includegraphics[width=.49\textwidth]{02_methods/figures/pat2.pdf}} \hfill
  \hspace*{\fill}
...
Once all these parameters have been inferred, the data are shifted as well as scale.
