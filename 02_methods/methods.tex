...
\begin{figure*}
  ...
  \\
  \hspace*{\fill}
  \subfigure[Start of enh.: 6\textsuperscript{th} serie;
  initial intensity: 117; wider st. dev.]{\label{subfig:pat1}\includegraphics[width=.49\textwidth]{02_methods/figures/pat1.pdf}} \hfill
  \subfigure[Start of enh.: 4\textsuperscript{th} serie;
  initial intensity: 103; narrower std. dev.]{\label{subfig:pat2}\includegraphics[width=.49\textwidth]{02_methods/figures/pat2.pdf}} \hfill
  \hspace*{\fill}
