...
\author[label1,label3]{Guillaume~Lema\^itre\corref{cor1}, MS}
\ead{g.lemaitre58@gmail.com}
\author[label3]{Robert~Mart\'i, PhD}
\author[label1]{Mojdeh~Rastgoo, PhD}
\author[label1]{Joan~Massich, PhD}
%\ead{marly@eia.udg.edu}
\author[label3]{Jordi~Freixenet, PhD}
%\ead{jordif@eia.udg.edu}
\author[label5]{Anke Meyer-Baese, PhD}
%\ead{ameyerbaese@fsu.edu}
\author[label4]{Joan~C.~Vilanova, MD}
%\ead{kvilanova@comg.cat}
%\author[label2]{Paul~M.~Walker}
%\ead{pwalker@u-bourgogne.fr}
\author[label1,label6]{Fabrice~Meriaudeau, PhD}
...
\cortext[cor1]{Corresponding author: Guillaume Lema\^itre, 12 rue de la Fonderie, 71200 Le Creusot, +33761104782}

\begin{abstract}
\begin{description}
  \item[Acknowledgements] None.
  \item[Grant support] Guillaume Lema\^itre is supported by the Generalitat de Catalunya (grant nb. FI-DGR2012) and partly by the Mediterranean Office for Youth (grant nb. 2011/018/06).
  \item[Running title] All you need is a good normalization
\end{description}
\end{abstract}
